...
_COLORS = np.array(
    [
        [1.0, 0.523602, 0.0],
        [0.5913978, 1.0, 0.37634408],
        [0.8030303, 0.0, 0.0],
        [0.0, 0.3, 1.0],
        [0.8064516, 1.0, 0.16129032],
        [0.0, 0.0, 0.5],
        [1.0, 0.7705156, 0.0],
        [0.0, 0.0, 0.8030303],
        [0.0, 0.56666666, 1.0],
        [0.0, 0.15882353, 1.0],
        [0.0, 0.8333333, 1.0],
        [0.2624921, 1.0, 0.70524985],
        [0.16129032, 1.0, 0.8064516],
        [0.9203036, 1.0, 0.04743833],
        [0.0, 0.0, 0.6426025],
        [1.0, 0.16049382, 0.0],
        [1.0, 0.90123457, 0.0],
        [1.0, 0.27668846, 0.0],
        [0.49019608, 1.0, 0.47754586],
        [0.37634408, 1.0, 0.5913978],
        [0.0, 0.69215685, 1.0],
        [0.70524985, 1.0, 0.2624921],
        [0.0, 0.4254902, 1.0],
        [0.0, 0.03333334, 1.0],
        [0.0, 0.0, 0.9456328],
        [0.6426025, 0.0, 0.0],
